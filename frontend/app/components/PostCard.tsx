...
const PostCard = ({ post, }) => {
  const searchParams = new URLSearchParams(`title=${post.frontMatter.title}&date=${post.frontMatter.date}`);
  return (
    <Link href={`/posts/${post.slug}`}>
      <div>
        <div className="shadow hover:shadow-2xl hover:shadow-indigo-500/50">
